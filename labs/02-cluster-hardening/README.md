...
1. **Prerequisites**: Required knowledge/setup
1. **Lab Setup**: Initial configuration
1. **Exercises**: Step-by-step tasks with expected outputs
1. **Verification**: How to confirm success
1. **Solutions**: Complete solutions with explanations
1. **Troubleshooting**: Common issues and fixes
1. **Cleanup**: Remove lab resources
...
1. Complete [Lab 01: RBAC Basics](lab-01-rbac-basics.md)
1. Complete [Lab 02: RBAC Advanced](lab-02-rbac-advanced.md)
1. Review and practice RBAC commands

### Week 2: Application Security

1. Read [ServiceAccounts theory](../../domains/02-cluster-hardening/service-accounts.md)
1. Complete [Lab 03: Service Accounts](lab-03-service-accounts.md)
1. Read [Security Contexts theory](../../domains/02-cluster-hardening/security-contexts.md)
1. Complete [Lab 04: Security Contexts](lab-04-security-contexts.md)

### Week 3: Policy Enforcement

1. Read [Pod Security Admission theory](../../domains/02-cluster-hardening/pod-security-admission.md)
1. Complete [Lab 05: Pod Security Admission](lab-05-pod-security-admission.md)
1. Review entire Domain 2 materials
1. Practice combined scenarios
...
1. Move to baseline enforcement (audit=restricted)
1. Achieve restricted enforcement
1. Document all required pod spec changes
...
1. Move to [Domain 3: System Hardening](../../domains/03-system-hardening/)
1. Practice mock questions for Domain 2
1. Revisit any challenging concepts
