...
1. **Network Plugin with NetworkPolicy Support**
...
1. Lab 04 (Pod Security Standards) - Essential security
1. Lab 03 (Ingress Security) - External access
1. Lab 02 (CIS Benchmarks) - Comprehensive audit
...
1. Repeat labs with time constraints
1. Practice without looking at solutions
1. Mix concepts (e.g., network policies + PSS)
...
1. **Type Commands**: Don't copy-paste blindly; understand what you're doing
1. **Verify Each Step**: Check output and confirm success before proceeding
1. **Take Notes**: Document interesting findings or gotchas
1. **Experiment**: Try variations to deepen understanding

### Troubleshooting

1. **Check Pod Status**: `kubectl get pods -A`
1. **View Pod Logs**: `kubectl logs <pod> -n <namespace>`
1. **Describe Resources**: `kubectl describe <resource> <name>`
1. **Check Events**: `kubectl get events --sort-by='.lastTimestamp'`
1. **Verify Configuration**: Use `kubectl get <resource> -o yaml`
...
1. **Review Documentation**: Links provided throughout labs
1. **Kubernetes Community**:

   - [Kubernetes Slack](https://kubernetes.slack.com/)
   - [Stack Overflow](https://stackoverflow.com/questions/tagged/kubernetes)
1. **KCSA Study Groups**: Join study groups for peer support
...
1. Practice labs multiple times for speed
1. Create your own scenarios
1. Move to Domain 2: [Cluster Hardening Labs](../02-cluster-hardening/)
