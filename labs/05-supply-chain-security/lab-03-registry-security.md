...
4. Wrong secret format
5. Secret in different namespace
...
2. Attach secrets to ServiceAccounts for automatic usage
3. Support multiple registries in a single secret
4. Cloud registries have specific authentication methods
5. ECR tokens expire and need rotation
6. Docker Content Trust enforces image signing
7. Admission policies can restrict allowed registries
8. Always verify signature policies before enforcement
9. Troubleshoot with kubectl describe and manual pulls
10. Test policies in audit mode before enforce mode

## Next Steps

1. Implement registry policies in your cluster
2. Set up automated credential rotation
3. Proceed to [Lab 04: SBOM Generation](./lab-04-sbom-generation.md)
