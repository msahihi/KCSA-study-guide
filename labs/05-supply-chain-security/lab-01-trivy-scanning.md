...
2. How many HIGH vulnerabilities?
3. Which library has the most vulnerabilities?
4. Are there any unfixed vulnerabilities?
...
2. Which packages are vulnerable?
3. Should you use a different base image?
...
2. **Why might a CRITICAL vulnerability show as "unfixed"?**
   <details>
   <summary>Click to see answer</summary>
...
3. **How would you scan for license compliance?**
   <details>
   <summary>Click to see answer</summary>
...
4. **How do you scan a private registry image?**
   <details>
   <summary>Click to see answer</summary>
...
2. Always scan images before deployment
3. Focus on HIGH and CRITICAL vulnerabilities
4. Use --ignore-unfixed to focus on actionable items
5. Minimal base images have fewer vulnerabilities
6. Regular scanning is essential (new CVEs appear daily)
7. Integrate scanning into CI/CD pipelines
8. Document and track CVE exceptions
9. Use multi-stage builds to minimize runtime dependencies
10. Keep vulnerability databases updated

## Next Steps

1. Review scan results for your production images
2. Create a remediation plan for critical vulnerabilities
3. Integrate Trivy into your CI/CD pipeline
4. Proceed to [Lab 02: Image Signing with Cosign](./lab-02-image-signing-cosign.md)
