...
def validate_pod():
    ...
    1. Containers must have resource limits
    1. Containers must not be privileged
    """
...
def mutate_pod():
    ...
    1. Add resource limits if missing (default values)
    """
    admission_review = request.get_json()
...
1. Create validating webhook server
1. Deploy webhook as Kubernetes service
1. Configure ValidatingWebhookConfiguration
1. Test policy enforcement
1. Create mutating webhook
1. Test automatic mutations
