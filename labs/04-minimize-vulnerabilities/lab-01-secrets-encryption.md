...
1. Generated encryption keys
1. Configured encryption at rest for Secrets
1. Modified kube-apiserver to enable encryption
1. Encrypted existing Secrets
1. Verified encryption in etcd
1. Performed key rotation
1. Tested and validated the encryption setup
