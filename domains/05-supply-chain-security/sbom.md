...
2. **License Compliance**: Track open-source licenses and ensure compliance
3. **Supply Chain Transparency**: Understand your complete dependency tree
4. **Incident Response**: Rapidly assess impact of security incidents
5. **Regulatory Compliance**: Meet requirements like Executive Order 14028 (US)
6. **Risk Assessment**: Understand what third-party code you're running
...
2. **Component Name**: What the component is
3. **Version**: Which version
4. **Other Unique Identifiers**: PURL, CPE
5. **Dependency Relationships**: How components relate
...
2. SPDX and CycloneDX are the main standards
3. Generate SBOMs at build time
4. Store SBOMs with container images
5. Use SBOMs for vulnerability management
6. Track licenses for compliance
7. Automate SBOM generation in CI/CD
8. Sign and verify SBOMs
9. Use SBOMs for incident response
10. SBOM quality matters - follow NTIA minimum elements

## Exam Tips

1. Know how to generate SBOMs with Trivy and Syft
2. Understand SPDX and CycloneDX formats
3. Practice querying SBOMs with jq
4. Know how to attach SBOMs to images
5. Understand SBOM use cases
6. Be able to scan SBOMs for vulnerabilities
7. Know NTIA minimum elements
...
2. Generate SBOMs for your images
3. Practice analyzing SBOMs
4. Integrate SBOM generation into CI/CD
